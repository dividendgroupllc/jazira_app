...
def generate_pl_pdf(filters):
	"""Generate a branded Jazira PDF of the Profit and Loss Statement report.
	...
	and renders them into a Jazira-styled HTML -> PDF, rather than a
	...
	try:
		...
		frappe.log_error(frappe.get_traceback(), "Jazira PL PDF Error")
